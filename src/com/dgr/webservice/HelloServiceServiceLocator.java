...
public class HelloServiceServiceLocator extends org.apache.axis.client.Service implements com.dgr.webservice.HelloServiceService {
    ...
    private java.lang.String HelloService_address = "http://localhost:8080/WebService1/services/HelloService";
    ...
    public com.dgr.webservice.HelloService getHelloService() throws javax.xml.rpc.ServiceException {
    ...
    public com.dgr.webservice.HelloService getHelloService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.dgr.webservice.HelloServiceSoapBindingStub _stub = new com.dgr.webservice.HelloServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.dgr.webservice.HelloService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.dgr.webservice.HelloServiceSoapBindingStub _stub = new com.dgr.webservice.HelloServiceSoapBindingStub(new java.net.URL(HelloService_address), this);
                _stub.setPortName(getHelloServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.dgr.com", "HelloServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.dgr.com", "HelloService"));
        }
